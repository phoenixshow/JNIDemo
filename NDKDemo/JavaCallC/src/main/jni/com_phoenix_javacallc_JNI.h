...
#include <jni.h>
/* Header for class com_phoenix_javacallc_JNI */

#ifndef _Included_com_phoenix_javacallc_JNI
#define _Included_com_phoenix_javacallc_JNI
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_phoenix_javacallc_JNI
 * Method:    add
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_phoenix_javacallc_JNI_add
