...
#include <jni.h>
/* Header for class com_phoenix_ccalljava_JNI */

#ifndef _Included_com_phoenix_ccalljava_JNI
#define _Included_com_phoenix_ccalljava_JNI
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_phoenix_ccalljava_JNI
 * Method:    callbackAdd
 * Signature: ()V
 */
